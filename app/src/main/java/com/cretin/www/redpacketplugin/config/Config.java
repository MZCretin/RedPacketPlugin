package com.cretin.www.redpacketplugin.config;
...
public class Config {
    ...
    public boolean isEnableWechat() {
        return KV.get(KEY_WECHAT_ENABLE, true);
    }
    ...
    public int getWechatAfterOpenHongBaoEvent() {
        return KV.get(KEY_WECHAT_AFTER_OPEN_HONGBAO, 0);
    }
    ...
    public int getWechatAfterGetHongBaoEvent() {
        return KV.get(KEY_WECHAT_AFTER_GET_HONGBAO, 1);
    }
    ...
    public int getWechatOpenDelayTime() {
        return KV.get(KEY_WECHAT_DELAY_TIME, 0);
    }
    ...
    public int getWechatMode() {
        return KV.get(KEY_WECHAT_MODE, 0);
    }
    ...
    public boolean isEnableNotificationService() {
        return KV.get(KEY_NOTIFICATION_SERVICE_ENABLE, false);
    }

    public void setNotificationServiceEnable(boolean enable) {
        KV.put(KEY_WECHAT_DELAY_TIME, enable);
    }
    ...
    public boolean isNotifySound() {
        return KV.get(KEY_NOTIFY_SOUND, true);
    }
    ...
    public boolean isNotifyVibrate() {
        return KV.get(KEY_NOTIFY_VIBRATE, true);
    }
    ...
    public boolean isNotifyNight() {
        return KV.get(KEY_NOTIFY_NIGHT_ENABLE, false);
    }
